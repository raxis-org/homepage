                ...
                <div className="lg:w-[1024px] m-auto flex flex-nowrap justify-between items-top">
                    <div className="flex flex-col w-[250px]">
                        ...
                        <div className="flex flex-nowrap justify-start gap-2 m-4" id="ft-sns-links">
                            <Link href="https://x.com/raxis.org/" className="bg-gradient-to-tr from-[var(--theme-1)] to-[var(--theme-3)]">
                                <FontAwesomeIcon icon={faXTwitter} />
                            </Link>
                            <Link href="https://www.instagram.com/raxis.tech/" className="bg-gradient-to-tr from-[var(--theme-1)] to-[var(--theme-3)]">
                                <FontAwesomeIcon icon={faInstagram} />
                            </Link>
                            <Link href="https://github.com/raxis-tech" className="bg-gradient-to-tr from-[var(--theme-1)] to-[var(--theme-3)]">
